...
//             <button className="text-gray-700"> <a href={detailMaintenancePath} className="no-underline hover:no-underline text-inherit"><TbListDetails className="text-2xl"/></a></button>
      ...
      cell: (row) => (
        <div className="flex gap-3">
          <button className="text-gray-700">
            <a href={detailMaintenancePath} className="no-underline hover:no-underline text-inherit">
